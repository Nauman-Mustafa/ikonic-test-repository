...
//we cn adjust it according to the requirment also 
        ...
        // Associating  the user with the merchant
...
//i was having null data query may also changes 
    public function getOrderStatistics(string $fromDate, string $toDate): array
    {
        return DB::table('orders')
            ...
            ->select(
                ...
                DB::raw('SUM(commission_owed) as commission_owed'),
